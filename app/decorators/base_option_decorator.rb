...
# Базовый декоратор. Его можно в дальнейшем применять как к монговой записи, так и к параметрам, переданным через http
class BaseOptionDecorator < Draper::Decorator
  delegate_all
